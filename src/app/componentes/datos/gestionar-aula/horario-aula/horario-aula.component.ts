...
import { AulaDTO } from 'src/app/componentes/dto/aula/out/aula.dto';
import { FranjaHorariaAulaDTO } from 'src/app/componentes/dto/aula/out/franja.horaria.aula.dto';
import { DiaSemanaEnum } from 'src/app/componentes/enum/dia.semana.enum';
import { AulaServicio } from 'src/app/componentes/servicios/aula.servicio';
...
export class HorarioAulaComponent {
	...
	public aulaDTOSeleccionado:AulaDTO;
	
	public listaFranjaHorariaAulaDTO: FranjaHorariaAulaDTO[] = [];
	...
	public abrirModal(aulaDTOSeleccionado:AulaDTO):void {
	...
	private consultarAula():void {
		...
		if (this.aulaDTOSeleccionado.idAula) {  					
		this.planificacionManualServicio.consultarFranjasAulaPorIdAula(this.aulaDTOSeleccionado.idAula).subscribe(
			(listaFranjaHorariaAulaDTO: FranjaHorariaAulaDTO[]) => {
	...
	private calcularFilasParaFranja(franja: FranjaHorariaAulaDTO, hora: Date): number {
